...
10. `Button primary lg` "Зареєструватись"
11. ToS: `Реєструючись, ти погоджуєшся з [Умовами використання]`
12. Перемикач: "Вже є акаунт? [Увійти]"
...
4. Якщо новий юзер і відсутнє фото або місто → inline prompt в попапі для заповнення
