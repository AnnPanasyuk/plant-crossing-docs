...
**Поля:** Ім'я · Місто (обов'язкове) · Email · Password (опціональний)
...
- Стан рослини (Chip Select)
- Діаметр горщика (Chip select) + висота рослини опційно (Input)
- Ціна або "Тільки обмін" (Toggle)
- Опис
- Контакти: телеграм або інстаграм (Input) одне з двох обовязкове
